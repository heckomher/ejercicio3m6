...
public class CapacitacionDao implements ICapacitacionDAO {
    ...
    public List<Capacitacion> obtenerCapacitaciones() {
        ...
        Capacitacion c3 = new Capacitacion(3 , "Limpieza del lugar de trabajo" , "Mantener limpio y seguro los ambientes de trabajo" ,"12.2653654-9" , "Lunes", "10:00" , "Administración" , "01:30" ,20);
